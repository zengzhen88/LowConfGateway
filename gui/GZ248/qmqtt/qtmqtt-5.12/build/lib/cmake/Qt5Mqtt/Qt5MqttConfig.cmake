...
set(Qt5Mqtt_VERSION_STRING 5.12.12)
...
if (NOT TARGET Qt5::Mqtt)
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.12 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Mqtt_process_prl_file(
            "${_qt5Mqtt_install_prefix}/lib/libQt5Mqtt.prl" RELEASE
    ...
    _populate_Mqtt_target_properties(RELEASE "libQt5Mqtt.a" "" FALSE)
