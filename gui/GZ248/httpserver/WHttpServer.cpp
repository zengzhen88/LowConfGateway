...
bool WHttpServer::addStaticWebDir(const string &dir, const string &header)
{
    ...
    ////Loge("11111WHttpServer::addStaticWebDir the dir path is wrong: %s", dir.c_str());
    //char *ptr = realpath(dir.c_str(), tempDir);
    //printf ("ptr:%p\n", ptr);
    printf ("PATH_MAX:%d\n", PATH_MAX);
