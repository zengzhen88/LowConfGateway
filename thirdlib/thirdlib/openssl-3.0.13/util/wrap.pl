...
BEGIN {
    ...
    require '/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/test/fips-and-base.cnf';
    shift;
