...
.p2align	6
.def	aesni_cbc_sha1_enc_shaext;	.scl 3;	.type 32;	.endef
.p2align	5
...
.byte	102,15,56,221,209
	...
	movdqu	%xmm8,(%r9)
	movd	%xmm9,16(%r9)
	movaps	-8-160(%rax),%xmm6
	movaps	-8-144(%rax),%xmm7
	movaps	-8-128(%rax),%xmm8
	movaps	-8-112(%rax),%xmm9
	movaps	-8-96(%rax),%xmm10
	movaps	-8-80(%rax),%xmm11
	movaps	-8-64(%rax),%xmm12
	movaps	-8-48(%rax),%xmm13
	movaps	-8-32(%rax),%xmm14
	movaps	-8-16(%rax),%xmm15
	movq	%rax,%rsp
.Lepilogue_shaext:
	movq	8(%rsp),%rdi
	movq	16(%rsp),%rsi
...
ssse3_handler:
	...
	leaq	aesni_cbc_sha1_enc_shaext(%rip),%r10
	cmpq	%r10,%rbx
	jb	.Lseh_no_shaext
