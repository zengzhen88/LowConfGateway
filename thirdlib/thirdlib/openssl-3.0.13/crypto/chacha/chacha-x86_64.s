...
.def	ChaCha20_ctr32;	.scl 2;	.type 32;	.endef
.p2align	6
ChaCha20_ctr32:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_ctr32:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_ctr32:
.def	ChaCha20_ssse3;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_ssse3:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_ssse3:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_ssse3:
.def	ChaCha20_128;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_128:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_128:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_128:
.def	ChaCha20_4x;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_4x:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_4x:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_4x:
.def	ChaCha20_4xop;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_4xop:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_4xop:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_4xop:
.def	ChaCha20_8x;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_8x:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_8x:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_8x:
.def	ChaCha20_avx512;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_avx512:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_avx512:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_avx512:
.def	ChaCha20_avx512vl;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_avx512vl:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_avx512vl:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_avx512vl:
.def	ChaCha20_16x;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_16x:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_16x:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ChaCha20_16x:
.def	ChaCha20_8xvl;	.scl 3;	.type 32;	.endef
.p2align	5
ChaCha20_8xvl:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ChaCha20_8xvl:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.byte	9,0,0,0
.rva	simd_handler
.rva	.Lavx512vl_body,.Lavx512vl_epilogue
.long	0x20,0

.LSEH_info_ChaCha20_16x:
.byte	9,0,0,0
.rva	simd_handler
.rva	.L16x_body,.L16x_epilogue
.long	0xa0,0

.LSEH_info_ChaCha20_8xvl:
.byte	9,0,0,0
.rva	simd_handler
.rva	.L8xvl_body,.L8xvl_epilogue
.long	0xa0,0
