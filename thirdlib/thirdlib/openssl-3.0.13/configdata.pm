...
our %config = (
    ...
    "cflags" => [],
    "conf_files" => [
        "/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations/00-base-templates.conf",
        "/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations/10-main.conf"
    ],
    "cppflags" => [],
    "cxxflags" => [],
    "defines" => [
    ...
    "openssldir" => "",
    "options" => "--prefix=/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib//common/openssl-3.0.13/windows -g -static no-acvp-tests no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-module no-msan no-pic no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-threads no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "13",
    "perl_archname" => "x86_64-msys-thread-multi",
    "perl_cmd" => "perl",
    "perl_version" => "5.38.2",
    "perlargv" => [
        "--prefix=/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib//common/openssl-3.0.13/windows",
        "-g",
        "-static"
    ],
    "perlenv" => {
...
our %target = (
    ...
    "_conf_fname_int" => [
        ...
        "/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations/10-main.conf",
        "/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations/10-main.conf",
        "/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations/shared-info.pl"
    ],
    "asm_arch" => "x86_64",
...
unless (caller) {
    ...
    use lib '/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/util/perl';
    use OpenSSL::fallback '/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/zeng/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations';
        use gentemplate;
