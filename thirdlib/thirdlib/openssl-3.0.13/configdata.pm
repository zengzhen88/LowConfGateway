...
unless (caller) {
    ...
    use lib '/home/zeng/share/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/util/perl';
    use OpenSSL::fallback '/home/zeng/share/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/zeng/share/gateway/LowConfGateway/thirdlib/thirdlib/openssl-3.0.13/Configurations';
        use gentemplate;
